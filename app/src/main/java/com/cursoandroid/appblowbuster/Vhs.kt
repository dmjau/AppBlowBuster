...
class Vhs (protected var fechaDeFabricacion_VHS: Int,
           ...
           var idiomaSubtitulos_VHS: String): Peliculas(codigoIMDB = codigoIMBD_VHS, titulo = titulo_VHS, fechaPublicacion = fechaPublicacion_VHS, idiomaSubtitulos = idiomaSubtitulos_VHS, formatoPelicula = FORMATO_PELICULA ) {
